...
/*!**************************************************!*\
  !*** ./components/alert-banner/alert-banner.mjs ***!
  \**************************************************/
/**
 * @file
      ...
      once('alertBannerBehaviour', '.view-alerts', context).forEach(() => {
        ...
        context.querySelectorAll('.dismiss').forEach(e => {
          e.addEventListener('click', function () {
            ...
            let updatedAlerts = existingAlerts ? "".concat(existingAlerts, ";").concat(alertId) : alertId;
            cookies.set('alert-banner', updatedAlerts, {
              expires: expiryDate
            });
          });
        });
